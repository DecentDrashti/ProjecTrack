    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-6">
      <div className="bg-white max-w-md w-full p-8 rounded-lg shadow-lg">
        ...
        <h1 className="text-3xl font-bold text-gray-800 mb-4 text-center">
          {data?.StaffName || 'Faculty Not Found'}
        </h1>
        ...
        {data ? (
          <div className="space-y-3">
            <p className="text-gray-600">
              <span className="font-semibold">Faculty ID:</span> {data.StaffID}
            </p>
            <p className="text-gray-600">
                <span className="font-semibold">Role:</span> {data.role}
            </p>
            <p className="text-gray-600">
                <span className="font-semibold">Faculty Name:</span> {data.StaffName}
            </p>
            <p className="text-gray-600">
          ...
          <p className="text-red-500 text-center">No faculty found with this ID.</p>
        )}
